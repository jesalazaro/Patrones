...
# Example usage
input_filename = 'tiempos_fiabilidad.txt'  # Replace with your input file name
...
output_file_path = 'final_2.csv'  # Replace with the desired path for the output file
...
output_file_path = 'averages_transponse_2.csv'  # Replace with the desired path for the output file
