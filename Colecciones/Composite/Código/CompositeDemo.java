...
public class CompositeDemo {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(" El tamaño del directorio principal es: " + mainFolder.getComponentSize() + " KB");
    System.out.println(" El tamaño de la subcarpeta 1 es: " + subFolder1.getComponentSize() + " KB");
    System.out.println(" El tamaño del archivo DatosAbril1.txt es: " + folder1File1.getComponentSize() + " KB");
    System.out.println(" El tamaño del archivo DatosMayo2.txt es: " +  folder2File2.getComponentSize() + " KB");
  }
}
